...
public:
   ...
   uint              HistoryColor(void)                const { return(m_history.clr);         }
   ...
   void              HistoryColor(const uint clr)      { m_history.clr=clr;          }
   ...
   for(int i=0; i<m_ysize; i++)
     {
      ...
      m_canvas.TextOut(m_left-yi_width-m_mark_size-m_gap,m_yc[i]-yh/2,yvalue,m_y.Color(),TA_LEFT);
      if(m_mark_size>0.0)
         m_canvas.LineHorizontal(x1,x2,m_yc[i],m_y.Color());
     }
//--- set font x
   ...
   for(int i=0; i<m_xsize; i++)
     {
      ...
      //--- draw mark and set y value
      m_canvas.TextOut(m_xc[i]-xw/2,y2+m_gap,xvalue,m_x.Color());
      if(m_mark_size>0.0)
         m_canvas.LineVertical(m_xc[i],y1,y2,m_x.Color());
     }
//---        
  }
//+------------------------------------------------------------------+
   ...
   for(int i=0; i<m_arr_curves.Total(); i++)
     {
      ...
      //--- draw text
      m_canvas.TextOut(xct,yct,name,m_history.clr);
