...
bool StrToPeriod(const string strper,ENUM_TIMEFRAMES& period)
  {
   bool res=true;
//--- monthly
   if(strper=="MN" || strper=="MN1" || strper=="MONTH" || strper=="MONTHLY")
      period=PERIOD_MN1;
   else // weekly
      if(strper=="W" || strper=="W1" || strper=="WEEK" || strper=="10080" || strper=="WEEKLY")
         period=PERIOD_W1;
      else // daily
         if(strper=="D" || strper=="D1" || strper=="DAY" || strper=="1440" || strper=="DAILY")
            period=PERIOD_D1;
         else // hours
            if(strper=="H" || strper=="H1" || strper=="HOUR" || strper=="60")
               period=PERIOD_H1;
            else
               if(strper=="H12" || strper=="720")
                  period=PERIOD_H12;
               else
                  if(strper=="H8" || strper=="480")
                     period=PERIOD_H8;
                  else
                     if(strper=="H6" || strper=="360")
                        period=PERIOD_H6;
                     else
                        if(strper=="H4" || strper=="240")
                           period=PERIOD_H4;
                        else
                           if(strper=="H3" || strper=="180")
                              period=PERIOD_H3;
                           else
                              if(strper=="H2" || strper=="120")
                                 period=PERIOD_H2;
                              else  // minutes
                                 if(strper=="M" || strper=="M1" || strper=="MIN" || strper=="1" || strper=="MINUTE")
                                    period=PERIOD_M1;
                                 else
                                    if(strper=="M30" || strper=="30")
                                       period=PERIOD_M30;
                                    else
                                       if(strper=="M20" || strper=="20")
                                          period=PERIOD_M20;
                                       else
                                          if(strper=="M15" || strper=="15")
                                             period=PERIOD_M15;
                                          else
                                             if(strper=="M12" || strper=="12")
                                                period=PERIOD_M12;
                                             else
                                                if(strper=="M10" || strper=="10")
                                                   period=PERIOD_M10;
                                                else
                                                   if(strper=="M6" || strper=="6")
                                                      period=PERIOD_M6;
                                                   else
                                                      if(strper=="M5" || strper=="5")
                                                         period=PERIOD_M5;
                                                      else
                                                         if(strper=="M4" || strper=="4")
                                                            period=PERIOD_M4;
                                                         else
                                                            if(strper=="M3" || strper=="3")
                                                               period=PERIOD_M3;
                                                            else
                                                               if(strper=="M2" || strper=="2")
                                                                  period=PERIOD_M2;
                                                               else // unknown
                                                                  res=false;
//---
