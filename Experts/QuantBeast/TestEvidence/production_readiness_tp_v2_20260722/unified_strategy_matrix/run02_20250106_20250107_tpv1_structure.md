...
Rows: 10; minimum: 0.077; median: 0.129; maximum: 0.567
...
| Combination | Rows |
| --- | --- |
| slope + impulse_displacement + pullback_returning | 44 |
| slope + impulse_efficiency + impulse_displacement + pullback_returning | 30 |
| impulse_displacement + pullback_returning | 10 |
| slope + pullback_returning | 6 |
...
| slope + impulse_efficiency + pullback_equilibrium + pullback_returning | 2 |

## State and failure combination

| State | Combination | Rows |
| --- | --- | --- |
| STRUCTURE_BALANCED | slope + impulse_displacement + pullback_returning | 32 |
| STRUCTURE_BALANCED | slope + impulse_efficiency + impulse_displacement + pullback_returning | 20 |
...
| STRUCTURE_FAILED_BREAKOUT | slope + impulse_displacement + pullback_returning | 6 |
...
| STRUCTURE_FAILED_BREAKOUT | slope + impulse_efficiency + pullback_equilibrium + pullback_returning | 2 |
