...
**Current readiness:** genuinely live on Coinexx-Demo (login 871221) as of 2026-07-24 19:46 -- BO/FBO/MR/TPV2(experimental=true) all authorized and trading-capable, TP V1 permanently excluded, 0.01 lot/1 position caps, 14-day lease (`qb-live-20260724-05-longrun`, expires 2026-08-07). This supersedes the "READY FOR SHADOW MODE"/"Live and Challenge operation prohibited" framing below, per the user's explicit blanket demo-only authorization (2026-07-24) -- see the dated entries immediately below for exactly what changed and why.
