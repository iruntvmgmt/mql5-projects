...
RERUN VERSION: this runs against D029_Audit_Results, the FINAL rerun
batch on the fully-patched binary (Finding C's atomicity fix, Finding D's
volume-min fix, Finding E's broker-authoritative sizing, AND Finding B's
deal-level R-computation fix -- all applied). This is the certification
evidence itself, not a pre-rerun baseline.
"""
...
ROOTS = {
    "D29_SR0": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/D29_SR0",
    "D29_P3": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/D29_P3",
    "D29_P4": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/D29_P4",
    "SR3_PCT": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/SR3_PCT",
    "SR4_PCT": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/SR4_PCT",
    "P3_SR3": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/P3_SR3",
    "P4_SR3": "/Users/matt/MT5-MSZZ-TEST/D029_Audit_Results/P4_SR3",
}
...
with open(f"{OUT}/portfolio_integrity_audit_rerun.csv", "w", newline='') as f:
...
with open(f"{OUT}/output_hashes_rerun.csv", "w", newline='') as f:
    w = csv.DictWriter(f, fieldnames=["variant", "file", "sha256"])
    w.writeheader()
    for r in hash_rows:
        w.writerow(r)

print(f"\nWrote {OUT}/portfolio_integrity_audit_rerun.csv ({len(summary_rows)} variants)")
print(f"Wrote {OUT}/output_hashes_rerun.csv ({len(hash_rows)} files hashed)")
print(f"\noverall_integrity_ok = {overall_ok}")
print("NOTE: this is the FINAL post-Finding-B-fix rerun evidence (D029_Audit_Results) -- this is the certification basis.")
